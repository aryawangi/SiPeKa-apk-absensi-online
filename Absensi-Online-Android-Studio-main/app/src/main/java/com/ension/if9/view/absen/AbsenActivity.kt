package com.ension.if9.view.absen
...
import com.ension.if9.BuildConfig
import com.ension.if9.R
import com.ension.if9.utils.BitmapManager.bitmapToBase64
import com.ension.if9.viewmodel.AbsenViewModel
...
class AbsenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set nilai awal inputTanggal dengan tanggal dan waktu saat ini
        inputTanggal.setText(simpleDateFormat.format(calendar.time))

        // Nonaktifkan kemampuan pengguna untuk mengedit inputTanggal
        inputTanggal.isFocusable = false
        inputTanggal.isClickable = false
        inputTanggal.isEnabled = false

        // Tampilkan date picker saat inputTanggal diklik
    ...
    private fun showDatePicker() {
        val datePickerDialog = DatePickerDialog(
            ...
            { _: DatePicker, year: Int, monthOfYear: Int, dayOfMonth: Int ->
                // Update nilai calendar dengan tanggal yang dipilih
                calendar.set(year, monthOfYear, dayOfMonth)
                val strFormatDefault = "dd MMMM yyyy HH:mm"
                val simpleDateFormat = SimpleDateFormat(strFormatDefault, Locale.getDefault())

                // Update inputTanggal dengan tanggal yang dipilih
                inputTanggal.setText(simpleDateFormat.format(calendar.time))
            },
        ...
        // Batasi tanggal yang dapat dipilih (hanya hari ini dan seterusnya)
