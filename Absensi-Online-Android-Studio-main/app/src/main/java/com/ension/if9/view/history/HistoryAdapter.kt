package com.ension.if9.view.history
...
import com.ension.if9.utils.BitmapManager.base64ToBitmap
...
class HistoryAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (data.keterangan) {
            "Absen Masuk","Hadir","Masuk","masuk","MASUK","HADIR" -> {
            ...
            "Absen Keluar","Keluar","keluar","KELUAR" -> {
                holder.colorStatus.setBackgroundResource(R.drawable.bg_circle_radius)
